...
# File ReCategorize
#
# Loop around recategorizing unknown url files forever
...
my $opt_tmp_directory		= 'C:\\Content\\recategorize';
my $opt_tmp_ext				= '.tmp';
my $opt_final_directory		= 'C:\\Content\\recategorize\\processed';
...
When new files come in, grab them, and then recategorize all the URLs listed
in them.
If nothing is going on, sleep for 10 minutes before checking for more files.

Directories used are
c:\\content\\recategorize
c:\\content\\recategorize\\processed
g:\\content\\recategorize
    
  -c, --child       number of child tasks to recategorize the urls
                    default is 3.
